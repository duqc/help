...
function createDiv(char, size) {
	...
	div.src = "https://avatars.cloudflare.steamstatic.com/6dd71aaa20d39b06e4d810e6965c6a7b895b2a81_full.jpg";
	sty.backgroundColor = "transparent";
	sty.visibility = "hidden";
	sty.zIndex = "101";
	let hueshift = Math.floor(Math.random()*360) 
	sty.filter = "hue-rotate("+hueshift+"deg) saturate(4)"
...
function bang(N) {
	...
	for (i = sparks * N; i < sparks * (N + 1); i++) {
		if (decay[i]) {
			...
			if (decay[i] == 16) Z.opacity = "75%";
			else if (decay[i] == 7) Z.opacity = "25%";
